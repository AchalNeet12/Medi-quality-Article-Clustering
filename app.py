...
# Set the app tab name - This should be the first Streamlit command
st.set_page_config(page_title="Medi quality Article Clustering")
...
set_background("backgroundimg.webp")
...
# Streamlit UI
st.title("Medi quality Article Clustering")
